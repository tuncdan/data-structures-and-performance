...
public class AutoSpellingTextArea extends StyledTextArea<Boolean> {
	...
	private src.spelling.AutoComplete ac;
	private src.spelling.Dictionary dic;
	private src.spelling.SpellingSuggest ss;
	...
	public AutoSpellingTextArea(src.spelling.AutoComplete ac, src.spelling.SpellingSuggest ss, src.spelling.Dictionary dic) {
	...
	private void showSuggestions(String word, MouseEvent click) {
		...
		item.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent actionEvent) {
				...
				dic.addWord(word);
				((src.spelling.Dictionary) ac).addWord(word);
